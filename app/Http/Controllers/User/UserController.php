...
class UserController extends Controller
{
    ...
    public function index(Request $request, $role = null)
    {
        ...
        return view('user.users.index', ['users' => $users->sortable(['email' => 'asc'])->paginate()]);
    }
    ...
    {
        return view('user.users.edit', ['user' => $user, 'roles' => Role::get()]);
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->intended(route('user.users.show', Auth::user()->id));
    }
    ...
    public function uploadAvatar()
    {
        if (Input::file('file')) {
            ...
            Avatar::where('user_id', Auth::user()->id)->delete();
